...
(formObj.receivers ? formObj.receivers.split(",") : []).forEach((function (receiverValue) { 
    ...
    form.insertAdjacentElement("beforeend", hiddenInput) })), formObj.formname) { 
        ...
        successBox.style.display = "none", successBox.innerHTML = formObj.formmsgsuccess, form.insertAdjacentElement("beforeend", successBox); 
        var titleStyles = { color: formObj.inputtitlecolor || "", fontWeight: formObj.inputtitlefontweight || "", fontFamily: formObj.inputfontfamily || "", fontSize: formObj.inputtitlefontsize || "", paddingBottom: formObj.inputtitlemargbottom || "" 
